...
:SpringApplication: http://docs.spring.io/spring-com.test.boot/docs/{spring_boot_version}/api/org/springframework/com.test.boot/SpringApplication.html
...
:com.test.boot.Model: http://docs.spring.io/spring/docs/{spring_version}/javadoc-api/org/springframework/ui/com.test.boot.Model.html
:toc:
:icons: font
:source-highlighter: prettify
:project_id: gs-serving-web-content
This guide walks you through the process of creating a "controller world" web site with Spring.
...
`src/main/java/controller/GreetingController.java`
[source,java]
----
include::complete/src/main/java/controller/GreetingController.java[]
----
...
A common feature of developing web apps is coding a change, restarting your app, and refreshing the browser to view the change. This entire process can eat up a lot of time. To speed up the cycle of things, Spring Boot comes with a handy module known as http://docs.spring.io/spring-com.test.boot/docs/current/reference/htmlsingle/#using-com.test.boot-devtools[spring-com.test.boot-devtools].

* Enable http://docs.spring.io/spring-com.test.boot/docs/current/reference/htmlsingle/#howto-hotswapping[hot swapping]
...
[source,java]
----
include::complete/src/main/java/controller/Application.java[]
----

include::https://raw.githubusercontent.com/spring-guides/getting-started-macros/master/spring-com.test.boot-application.adoc[]
